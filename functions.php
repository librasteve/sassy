...
function sassy_scripts() {
	wp_enqueue_style( 'sassy-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'sassy-style', 'rtl', 'replace' );

	wp_enqueue_script( 'sassy-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
